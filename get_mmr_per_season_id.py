...
# get current season = https://us.api.battle.net/data/sc2/season/current?locale=en_US&access_token=yv7ajx74qgefkefdpwjkmqvn
# get specific season = https://us.api.battle.net/data/sc2/league/28/201/0/5?locale=en_US&access_token=yv7ajx74qgefkefdpwjkmqvn
# Queue ID 201 legacy of the void 1v1. 
# Team type 0 for matched
# league id 0-6 for bronze to GM
# get mmr for ladder id = https://us.api.battle.net/data/sc2/ladder/271302?locale=en_US&access_token=yv7ajx74qgefkefdpwjkmqvn
...
season_call = 'https://us.api.battle.net/data/sc2/league'
season_id = 37 #this should be the 10-2018 season
lotv_1v1_ladder_code = 201
match_made_code = 0
#0-6 is bronze to GM
league_code = 0
eng_locale = '?locale=en_US'
slash = '/'
...
# get mmr for ladder id = https://us.api.battle.net/data/sc2/ladder/271302?locale=en_US&access_token=yv7ajx74qgefkefdpwjkmqvn
ladder_call = 'https://us.api.battle.net/data/sc2/ladder'
